        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <section class="py-5">
                <div class="container px-5 my-5">
                    ...
                    <div class="row gx-5">
                        <!--PHP for displaying image for theme and image type-->
                        <?php
                            ...
                            if($result = $conn->query($myquery)){
                                while ($line =$result->fetch_assoc()){
                                    $themeType = $line["Theme"];
                                    $Image = $line["ThemeImage"];
                            ...
                            <div class="card h-100 shadow border-0">
                                ...
                                <div class="card-body p-4">
                                    <a class="text-decoration-none link-dark stretched-link" href="themes.php?theme=$themeType"><h5 class="card-title mb-3">$themeType</h5></a>
