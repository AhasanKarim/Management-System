...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        ...
        <!--PHP for home banner image and text-->
        <?php
            ...
            $myquery = "SELECT HomePage, AboutImage FROM about WHERE AboutID = 1";
            $result=mysqli_query($conn,$myquery);
            $line = mysqli_fetch_assoc($result);
            $homeText=$line["HomePage"];
                        ...
                        <div class="row gx-5 align-items-center justify-content-center">
                            <div class="col-lg-8 col-xl-7 col-xxl-6">
                                <div class="my-5 text-center text-xl-start">
                                    ...
                                    <p class="lead fw-normal text-white-50 mb-4">$homeText</p>
                                    <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                        <a class="btn btn-primary btn-lg px-4 me-sm-3" href="about.php">about</a>
