...
<body class="d-flex flex-column h-100">
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-normal text-muted mb-4">We are a group of community artists who are dedicated to bringing art to our community. we display our work both to record community eventsand for sale.</p>
            ...
            <!--PHP for about banner image and text-->
            <?php
            ...
            $myquery = "SELECT Story, AboutImage FROM about WHERE AboutID = 1";
            $result=mysqli_query($conn,$myquery);
            $line=$result->fetch_assoc();
            $aboutStory=$line["Story"];
            $image = $line["AboutImage"];
            $outout = <<<HTML
                <!-- About section one-->
                ...
                <div class="container px-5 my-5">
                    <div class="row gx-5 align-items-center">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="lead fw-normal text-muted mb-0">$aboutStory</p>
                        </div>
                    </div>
                </div>
            </section>
